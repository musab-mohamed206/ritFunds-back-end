...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="rtl">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('jquery-circle-progress') }}/docs/styles.css">
    <!--     Fonts and icons     -->
    ...
    <script src="{{ url('/jquery-circle-progress/dist/circle-progress.js') }}"></script>
    ...
    <body class="{{ $class ?? '' }}">
        ...
        <!-- images -->
        <script src="{{ url('/js/superbox/js/superbox.js') }}"></script>
        <script src="{{ url('/js/form-multiple-upload.demo.js') }}"></script>
        <script src="{{ url('/js/gallery-v2.demo.min.js') }}"></script>
        @stack('js')
        @yield('scripts')
